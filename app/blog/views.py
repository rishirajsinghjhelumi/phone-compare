...
def index():
    ...
    return object_list(
        ...
        query,
        search=search_query,
        check_bounds=False, allTopBrands = allBrands[0:7],allNonTopBrands = allBrands[11:18], title="Blog")
...
def detail(slug):
    ...
    return render_template('detail.html', entry=entry, allTopBrands = allBrands[0:7],allNonTopBrands = allBrands[11:18],title=entry.title)
