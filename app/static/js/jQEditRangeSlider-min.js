...
function(t) {
    ...
    t.widget("ui.rangeSlider", {
        ...
        _updateRuler: function() {
            this._destroyRuler(), this.options.scales !== !1 && t.fn.ruler && (null === this.ruler && this._createRuler(), this.ruler.ruler({
...
function(t) {
    ...
    t.widget("ui.editRangeSliderLabel", t.ui.rangeSliderLabel, {
        ...
        _createInput: function() {
            this._input = t("<input type='" + this.options.type + "' />").addClass("ui-editRangeSlider-inputValue").appendTo(this._valueContainer), this._setInputName(), this._input.bind("keyup", t.proxy(this._onKeyUp, this)), this._input.blur(t.proxy(this._onChange, this)), "number" === this.options.type && (this.options.step !== !1 && this._input.attr("step", this.options.step), this._input.click(t.proxy(this._onChange, this))), this._input.val(this._text)
        },
        ...
        _destroyInput: function() {
            this._input.detach(), this._input = null
        },
        _onKeyUp: function(t) {
